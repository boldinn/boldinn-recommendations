...
def recomendar_ejercicios(puntajes,ejercicios, n_rec):
  ...
  ejercicios_recomendadosxn=[escoger_ejercicios(puntajes,criterios) for criterios in criteriosxn]
  
  # ordenar ejercicios por puntajes en criterios (orden ascendente)
  ejercicios_recomendados_ordenadosxn=[organizar_ejercicios(ejercicios_recomendados) for ejercicios_recomendados in ejercicios_recomendadosxn]
...
def organizar_ejercicios(ejercicios_recomendados):
  ...
  criterios_con_niveles = [(code,calcular_nivel(ejercicio)) for code, ejercicio in ejercicios_recomendados.items()]
